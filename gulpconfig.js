...
// Project paths
var project     = 'royalty'                 // The directory name for your theme; change this at the very least!
...
module.exports = {
  ...
  , proxy: 'local.keny.com' // We need to use a proxy instead of the built-in server because WordPress has to do some server-side rendering for the theme to work
  , watchOptions: {
  ...
  , namespace: 'royalty-' // Script filenames will be prefaced with this (optional; leave blank if you have no need for it but be sure to change the corresponding value in `src/inc/assets.php` if you use it)
  },
  ...
  , fonts: {
      src: src+'fonts/**/*' // This simply copies PHP files over; both this and the previous task could be combined if you like
    , dest: build+'fonts/'
    }
  },

        ...
        <nav class="navbar navbar-default">
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <p class="navbar-text navbar-text-title hidden-xs">Mess experiencies</p>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laboriosam praesentium corporis sint quo explicabo facere inventore culpa eum qui id doloribus molestiae, ipsa quia nam enim, nesciunt vero ab rem!
            </div>
